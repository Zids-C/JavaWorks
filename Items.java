package Class;
import Interface.Int3;
import Interface.Int4;
import Interface.Int5;

import java.io.File;
import java.io.FileWriter;
import java.util.Scanner;

public class Items extends Function implements Int3, Int4, Int5 {
    String[] itemName;
    double[] price;
    int newItemID = -1;
    int arraySize = 100;
    ...
    public String[] getIteminfo(String itemName){
     ...
     public void editIteminfo(int itemID, String itemName, double price){
